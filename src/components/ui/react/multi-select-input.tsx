            ...
            <Popover open={open} onOpenChange={setOpen}>
                <PopoverTrigger asChild className={className}>
                    <Button
                        ...
                        role="combobox"
                        aria-expanded={open}
                        className={`group w-full justify-between bg-slate-100 dark:bg-background-color text-foreground ${selected.length > 1 ? "h-full" : "h-10"
                            }`}
                        ...
                        <div className="flex flex-wrap items-center gap-1">
                            {selected.map((item) => (
                                <Badge
                                    variant="outline"
                                    key={item.value}
                                    className="flex dark:border-none dark:outline-none items-center bg-white dark:bg-natural gap-1 group-hover:bg-white/20"
                                ...
                                >
                                    ...
                                    <Button
                                        ...
                                        variant="outline"
                                        size="icon"
                                        className="border-none  outline-none m-2"
                                        onKeyDown={(e) => {
                                            if (e.key === "Enter") {
                                                handleUnselect(item)
                                            }
                            ...
                            {selected.length === 0 && (
                                <span>{props.placeholder ?? "Choose vendors ..."}</span>
                            )}
                        </div>
